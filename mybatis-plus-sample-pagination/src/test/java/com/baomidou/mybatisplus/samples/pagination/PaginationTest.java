...
class PaginationTest {
    ...
    void lambdaPagination() {
        ...
        Page<User> result = userMapper.selectPage(page, Wrappers.<User>lambdaQuery()
                .ge(User::getAge, 1).orderByAsc(User::getAge));
    ...
    void tests1() {
        ...
        Page<User> userIPage = userMapper.selectPage(page, Wrappers.<User>lambdaQuery()
                .eq(User::getAge, 20).like(User::getName, "Jack"));
    ...
    void iPageTest() {
        IPage<User> page = new Page<User>(1, 5) {
            private static final long serialVersionUID = -7005156063022048004L;
    ...
    void lambdaPageTest() {
        ...
        userService.page(new Page<>(1, 10), wrapper2.getWrapper())
                .getRecords().forEach(System.out::print);
    }

    @Test
    void test() {
        userService.lambdaQuery().like(User::getName, "a")
